...
class StringsEs extends AppStrings {
  ...
  @override
  String get viewAsCards => 'En tarjetas';
  @override
  String get viewAsList => 'En lista';
  @override
  ...
  @override
  String get whichList => '¿En qué lista?';
  @override
  ...
  String wasteUploadOnlyBody(String town) =>
      '$town no permite que las apps consulten automáticamente sus fechas de recogida; así podéis traer vuestro calendario de recogida en pocos pasos.';
  @override
  String get openTownCalendarPage => 'Abrir el calendario de recogida del ayuntamiento';
  @override
  String get wasteUploadOnlyShort => 'Solo como archivo — toca para añadirlo';
  @override
  List<String> get binFileStepsInApp => [
    'Abrid abajo el calendario de recogida del ayuntamiento.',
    'Elegid vuestra calle.',
    'Tocad la descarga en iCal o ICS.',
    'aporah detecta el archivo automáticamente y lo trae directamente aquí.',
  ];
  @override
  List<String> get binFileStepsBrowser => [
    ...
    'Elegid vuestra calle.',
    'Tocad la descarga en iCal o ICS.',
    'Después subid aquí el archivo con «Subir un archivo de calendario».',
  ];
  @override
  String get calendarPagePrompt => 'Elegid vuestra calle y tocad la exportación iCal';
  @override
  String get calendarPageNotCalendar => 'Eso no es un archivo de calendario. Buscad «iCal» o «ICS» en la página.';
  @override
  String get calendarPageFailed => 'No se ha podido descargar el archivo. Volved a intentarlo.';
  @override
  String get ok => 'Vale';
  @override
  String get wasteUploadOnlyLater => 'Solo disponible como archivo — podéis añadirlo más tarde como archivo de calendario.';
  @override
  String get wasteOnTownPage => 'Fechas en la página del ayuntamiento';
  @override
  String get onboardWasteFileTitle => 'Vuestro calendario de recogida llega como archivo';
  @override
  String get pdfDistrictLabel => 'Vuestro distrito';
  @override
  String get wasteFileAdded => 'Calendario de recogida añadido como archivo';
  @override
  String wasteOwnPageBody(String town) =>
      '$town publica su calendario de recogida en su propia página; así podéis traerlo aquí en pocos pasos.';
  @override
  String get wasteLinkLater =>
      'Aún no lo hemos encontrado — podéis añadir el calendario más tarde como enlace o archivo.';
  @override
  List<String> get binFileStepsPdfInApp => [
    'Abrid abajo el calendario de recogida del ayuntamiento.',
    'Elegid vuestra localidad o calle.',
    'Tocad el calendario en iCal, ICS o PDF.',
    'aporah detecta el archivo automáticamente y lo trae directamente aquí.',
  ];
  @override
  List<String> get binFileStepsPdfBrowser => [
    ...
    'Elegid vuestra localidad o calle.',
    'Tocad el calendario en iCal, ICS o PDF.',
    'Después subid aquí el archivo con «Subir un archivo de calendario o PDF».',
  ];
  @override
  String get townPagePdfOnly =>
      'Allí el calendario solo está en PDF para imprimir, y la app no puede leerlo. Encontraréis las fechas en la página del ayuntamiento, y si ofrece un archivo iCal, podéis traerlo aquí.';
  @override
  String get townPageDatesOnly =>
      'Puede que las fechas solo aparezcan en la propia página. Buscad una exportación en iCal o ICS.';
  @override
  String get townPageAppOnly =>
      'Puede que las fechas solo estén en la app del ayuntamiento. Buscad en la página una exportación en iCal o ICS.';
  @override
  String get calendarPagePromptPdf =>
      'Elegid vuestra calle y descargad el calendario en iCal o PDF';
  @override
  String get calendarPageNotCalendarPdf =>
      'Eso no es un archivo de calendario. Buscad «iCal», «ICS» o «PDF» en la página.';
  @override
  String get pdfNotReadableYet =>
      'Es un PDF, y la app no puede leerlo. Elegid un archivo de calendario (iCal o ICS).';
  @override
  String get fileTooLarge =>
      'Este archivo es demasiado grande.';
  @override
  String get pickDistrictFirst =>
      'Elegid vuestro distrito.';
  @override
  String get pdfDistrictIntro =>
      'El plan cubre varios distritos. ¿Cuál es el vuestro? Las próximas fechas os ayudan a reconocerlo.';
  @override
  String nextPickups(String dates) =>
      'Próximas: $dates';
  @override
  String get wasteNeedsHouseNumber => 'Introduce la dirección con el número — aquí la recogida se planifica por casa.';
  @override
  String get houseNumberAsk =>
      '¿Y el número?';
  @override
  String get houseNumberAskHint =>
      'Para encontrar el calendario de recogida de tu casa.';
  @override
  String get houseNumberPlaceholder =>
      'p. ej. 12a';
  @override
  String get houseNumberInvalid =>
      'Introduce un número como 12 o 12a.';
  @override
  String get houseNumberUnknown =>
      'La empresa de recogida no reconoce este número — compruébalo.';
  @override
  String get addressPrivacyNote =>
      'La dirección solo se usa para encontrar la recogida de basura, las vacaciones escolares y el tiempo.';
  @override
  String get onboardRhythmTitle => 'Una pregunta más sobre la recogida';
  @override
  String get pickHouseNumberHint => 'Aquí la recogida se planifica por casa — elige tu número.';
  @override
  String rhythmQuestion(String bin) => '$bin — ¿cada cuánto se vacía?';
  @override
  String get rhythmHint => 'Figura en la pegatina de tu contenedor — es la misma pregunta que hace el calendario de la ciudad. Solo se mostrará ese ritmo.';
  @override
  String get pickRhythmFirst => 'Elige primero cada cuánto se vacía tu contenedor.';
  @override
  String get rhythmWeekly => 'semanal';
  @override
  String rhythmEveryWeeks(int n) => 'cada $n semanas';
  @override
  String get checkingRhythm => 'Comprobando el ritmo de recogida …';
  @override
  ...
  @override
  String get uploadCalendarFileOrPdf => 'Subir un archivo de calendario o PDF';
  @override
  ...
  @override
  String whoSeesTitle(String noun) => '¿Quién ve $noun?';

  @override
  String privateCannotShare(String noun) =>
      'Privada: solo se puede compartir cuando alguien más aparte de ti ve $noun. Cambia antes «¿Para quién?».';

  @override
  String visibilityLockedWhileShared(String noun) =>
      'Mientras $noun esté compartida fuera, «¿Para quién?» se queda como está; si no, la familia pierde el acceso.';

  @override
  String get visibilityLockedHowTo =>
      'Quita abajo a todos los invitados y las invitaciones abiertas para poder cambiarlo.';

  @override
  String get visibilityLockedHowToInShare =>
      'Quita en «Compartir» a todos los invitados y los enlaces para poder cambiarlo.';
  ...
  @override
  String get removeSymbol => 'Quitar símbolo';
  @override
  ...
  String get onboardSetUpFamilyBody =>
      'Dale a tu familia un nombre y una foto. Podéis cambiar las dos cosas más adelante.';
  @override
  String get onboardJoinExistingFamily => '¿Tu familia ya usa aporah?';
  @override
  String get onboardJoinExistingFamilyBody =>
      'Entonces no crees una nueva aquí: pídele a alguien de la familia que te invite.';
  @override
  ...
  // ----------------------------------------------------------------- auth --
  @override
  String get frontDoorTagline => 'Todo lo que mantiene unida a la familia, en un solo sitio.';
  @override
  String get demoMemberMama => 'Mamá';
  @override
  String get demoMemberPapa => 'Papá';
  @override
  String get demoMemberKid => 'Lina';
  @override
  String get demoListTitle => 'Lista de la compra';
  @override
  String get demoListItem => 'Pan';
  @override
  String get demoEventTitle => 'Entrenamiento de fútbol';
  @override
  String get demoTaskTitle => 'Sacar la basura';
  @override
  String get demoTrackerTitle => 'Deporte';
  @override
  String get emailPlaceholder => 'nombre@ejemplo.com';
  @override
  String get greetingWelcome => 'Hola';
  @override
  String get greetingWelcomeBack => 'Hola de nuevo';
  @override
  ...
  String get signInBlurb =>
      'Introduce tu correo electrónico. Te enviaremos un código: no necesitas contraseña.';
  @override
  ...
  String codeSentTo(String email) =>
      'Hemos enviado un código a $email. Introdúcelo aquí. ¿No ha llegado? Mira también en la carpeta de spam.';
  @override
  String get codeHint => 'Código del correo';
  @override
  String get verifyCode => 'Confirmar';
  @override
  String get resendCode => 'Enviar un código nuevo';
  @override
  String resendCodeIn(int seconds) => 'Nuevo código en $seconds s';
  @override
  String get useOtherEmail => 'Usar otro correo';
  @override
  String get codeInvalid => 'Ese código no es correcto o ha caducado.';
  @override
  String get noAccountForEmail => 'Todavía no hay ninguna cuenta con este correo electrónico.';

  // ---------------------------------------------------------- incoming links --
  @override
  String get joinHouseholdTitle => '¿Unirte a un hogar?';
  @override
  String get joinHouseholdBody =>
      'Te han invitado a un hogar. Si te unes, se borra tu hogar actual, junto con todo lo que hayas creado en él por tu cuenta.';
  @override
  String get joinHousehold => 'Unirme';
  @override
  String joinedHousehold(String name) => 'Bienvenido a $name';
  @override
  String joinNamedHouseholdTitle(String name) => '¿Unirte a $name?';
  @override
  String inviteWelcomeBody(String inviter, String household) =>
      '$inviter te ha invitado a $household. Compartiréis el calendario, las listas y el board.';
  @override
  String inviteWelcomeBodyNoInviter(String household) =>
      'Te han invitado a $household. Compartiréis el calendario, las listas y el board.';
  @override
  String inviteJoinNamed(String household) => 'Unirme a $household';
  @override
  String get inviteSetUpOwn => 'Crear mi propio hogar';
  @override
  String get inviteInvalid => 'Esta invitación no es válida o ya se ha usado.';
  @override
  String get inviteExpired => 'Esta invitación ha caducado. Pide una nueva.';
  @override
  String get inviteOtherEmail =>
      'Esta invitación se envió a otro correo electrónico. Inicia sesión con la dirección a la que se envió.';
  @override
  String get inviteLeaveFirst =>
      'Todavía estás en un hogar con otros miembros. Sal de él primero y después podrás unirte.';
  @override
  String get inviteAcceptFailed => 'No se ha podido aceptar la invitación. Inténtalo de nuevo.';
  @override
  String get shareLinkInvalid => 'Este enlace no es válido o ha caducado.';
  ...
  @override
  String get renamePerson => 'Renombrar persona';
  @override
  String get renamePersonBody =>
      'El nombre aparece en su pestaña en Calendario y en el Board, y en cada calendario asignado a ella.';
  @override
  String get removePersonQuestion => '¿Quitar persona?';
  @override
  String removePersonBody(String name) =>
      '“$name” no tiene cuenta y solo aparece en los calendarios asignados a ella. '
      'Esos calendarios vuelven a ser de toda la familia; no se desconecta nada.';
  @override
  ...
  String spendWalletOtherOwner(String name) =>
      'Este dispositivo registra gastos para $name: cada pago se anota con ese nombre. Actívalo de nuevo para que tus pagos queden a tu nombre.';
  ...
  String get paywallSpendBody =>
      'Con Plus, cada pago hecho con el móvil aparece aquí solo — ya ordenado por categoría, '
      'tienda y persona. Y un presupuesto por categoría que dice cuánto queda.';
  ...
  @override
  String get plannerShowMethod => 'Mostrar todo';
  @override
  ...
  @override
  String get plannerTypeInstead => 'Escribirlo yo';
  @override
  ...
  @override
  String get plannerPasteLink => 'Importar';

  @override
  String get plannerLinkOnClipboard => 'Enlace en el portapapeles';

  @override
  String get plannerClipboardUnreadable =>
      'No se ha podido leer el portapapeles.';

  @override
  String get plannerNoRecipeOnPage =>
      'En esa página no había ninguna receta. Escribe directamente qué quieres cocinar.';
  @override
  String get plannerNoRecipeInVideo =>
      'Ese vídeo no lleva los ingredientes en la descripción. Escribe directamente qué quieres cocinar.';
  @override
  ...
  String get searchTermsNotifications =>
      'notificaciones recordatorios avisos push resumen del día basura recogida presupuesto gastos mitteilungen';
  @override
  ...
  @override
  String get notifyBriefSubtitle => 'Lo que hay ese día';
  @override
  String get notifyAbfallTitle => 'Recogida de basura';
  @override
  String get notifyAbfallSubtitle => 'Para que el cubo esté fuera a tiempo';
  @override
  String get notifyAbfallWhen => 'Cuándo';
  @override
  String get notifyAbfallAdd => 'Otro recordatorio';
  @override
  String notifyAbfallMax(int count) => 'Como máximo $count';
  @override
  String reminderCount(int count) => '$count recordatorios';
  @override
  String get abfallDayBefore => 'El día antes';
  @override
  String get abfallSameDay => 'El día de la recogida';
  @override
  String get notifyTaskTimesTitle => 'To-dos con hora';
  @override
  String get notifyTaskTimesSubtitle => 'A la hora que pusiste';
  @override
  String get notifyBudgetsTitle => 'Presupuestos';
  @override
  String get notifyBudgetsSubtitle => 'Cuando un presupuesto se adelanta al mes o pasa su límite';
  @override
  ...
  @override
  String get firstStepBinReminder => 'Activar aviso de basura';
  @override
  String get firstStepBinReminderBody => 'La víspera, antes de sacar los cubos.';
  @override
  String get reminderAbfallShared => 'Se aplica a todas las recogidas, como en Ajustes';
  @override
  String get reminderAbfallCustom => 'Otra hora…';
  @override
  ...
  @override
  String get noticeAbfallBodyToday => 'La recogida es hoy.';
  @override
  String noticeTaskDue(String time) => 'Para las $time';
  @override
  String noticeBudgetAheadOne(String category) => '$category se adelanta al mes';
  @override
  String noticeBudgetAheadMany(int count) => '$count presupuestos se adelantan al mes';
  @override
  String noticeBudgetOverOne(String category) => '$category ha pasado su límite';
  @override
  String noticeBudgetOverMany(int count) => '$count presupuestos han pasado su límite';
  @override
  ...
  // -------------------------------------------------------------- app lock --
  @override
  String get appLockSubtitle => 'Se pide al abrir la app';
  @override
  String get appLockLockedTitle => 'aporah está bloqueada';
  @override
  String get appLockUnlockReason => 'Desbloquear aporah';
  @override
  String get appLockEnableReason => 'Activar el bloqueo de la app';
  @override
  String get appLockDisableReason => 'Desactivar el bloqueo de la app';
  @override
  String unlockWith(String method) => 'Desbloquear con $method';
  @override
  String get biometricFingerprint => 'huella dactilar';
  @override
  String get biometricFace => 'reconocimiento facial';
  @override
  String get biometricGeneric => 'biometría';
  @override
  String get biometricPasscode => 'código del dispositivo';
  @override
  String get searchTermsAppLock => 'face id touch id optic id huella dactilar cara bloqueo bloquear desbloquear biometría seguridad código privacidad';
  @override
