...
///
/// **There is no third value for a shelf, and that is the point.** The tab was
/// briefly a menu page listing the two, which cost a screen on the way in and a
/// back control on the way out of both. The choice is made in the system menu
/// the nav bar's **Mehr** item puts up (`showMoreMenu`), so by the time this
/// tab is on screen the question has already been answered.
